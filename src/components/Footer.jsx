                ...
                <div className="row">
                    <div className="col-lg-3 col-md-6">
                        <div className="footer-contact">
                            <h2>Contact Us</h2>
                            <a href="https://maps.app.goo.gl/HQg6gMPpAJ445cda6" target="_blank" rel="noopener noreferrer"><p><i className="fa fa-map-marker-alt"></i>22, Shanti Nagar,Shri Nagar Extension, Khajrana Road, Indore-452018, Madhya Pradhesh.</p></a>
                            <a href="tel:+91-7385223242"><p><i className="fa fa-phone"></i>+91-9425311547</p></a>
                            <a href="mailto:naishuruwat@gmail.com"><p><i className="fa fa-envelope"></i>naishuruwat@gmail.com</p></a>
            ...
            <div className="container copyright">
                <div className="row">
                    <div className="col-md-6">
                        <p>&copy; <a href="#">Nai Shuruwat</a> | 2024, All Right Reserved.</p>
                    </div>
                    <div className="col-md-6">
